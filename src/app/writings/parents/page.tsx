...
export const metadata: Metadata = {
  title: "Show honour to your parents \u2014 Bah\u00e1'u'll\u00e1h",
  description:
    "Say, O My people! Show honour to your parents and pay homage to them.",
}

export default function ParentsQuotePage() {
  return (
    <StandalonePage>
      <div className="flex w-full flex-auto items-center justify-center px-6 py-16 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <StandaloneImage
            src="/writings-nature/parents-old-aspen-01_00001_.png"
            alt=""
          ...
          <figure>
            <blockquote>
              <p className="font-display text-2xl font-normal leading-relaxed text-burgundy-900 sm:text-3xl lg:text-4xl">
                &ldquo;Say, O My people! Show honour to your parents and pay
                homage to them. This will cause blessings to descend upon you
                from the clouds of the bounty of your Lord, the Exalted, the
                Great.&rdquo;
              </p>
            </blockquote>
