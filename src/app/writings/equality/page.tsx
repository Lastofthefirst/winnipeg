...
export const metadata: Metadata = {
  title: "The world of humanity has two wings \u2014 \u2018Abdu'l\u2011Bah\u00e1",
  description:
...
export default function EqualityQuotePage() {
  return (
    <StandalonePage>
      <div className="flex w-full flex-auto items-center justify-center px-6 py-16 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <StandaloneImage
            src="/writings-nature/equality-two-butterflies-01_00001_.png"
            alt=""
          ...
          <figure>
            <blockquote>
              <p className="font-display text-2xl font-normal leading-relaxed text-burgundy-900 sm:text-3xl lg:text-4xl">
                &ldquo;The world of humanity has two wings\u2014one is women and
                the other men. Not until both wings are equally developed can
                the bird fly. Should one wing remain weak, flight is
                impossible.&rdquo;
              </p>
            </blockquote>
