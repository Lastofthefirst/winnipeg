...
export const metadata: Metadata = {
  title: "Man is even as steel \u2014 Bah\u00e1'u'll\u00e1h",
  description:
...
export default function SteelQuotePage() {
  return (
    <StandalonePage>
      <div className="flex w-full flex-auto items-center justify-center px-6 py-16 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <StandaloneImage
            src="/writings-nature/steel-cairn-01_00001_.png"
            alt=""
          ...
          <figure>
            <blockquote>
              <p className="font-display text-2xl font-normal leading-relaxed text-burgundy-900 sm:text-3xl lg:text-4xl">
                &ldquo;Man is even as steel, the essence of which is hidden:
                Through admonition and explanation, good counsel and education,
                that essence will be brought to light. If, however, he be
                allowed to remain in his original condition, the corrosion of
                lusts and appetites will effectively destroy him.&rdquo;
              </p>
            </blockquote>
