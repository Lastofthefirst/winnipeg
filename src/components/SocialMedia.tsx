...
export const socialMediaProfiles = [
  { title: 'Facebook', href: 'https://www.facebook.com/WinnipegBahais', icon: FacebookIcon },
  { title: 'Instagram', href: 'https://www.instagram.com/winnipegbahais', icon: InstagramIcon },
]
